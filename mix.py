...
def main():
    ...
    draw_style_mixing_figure(os.path.join('father_imgs', 'mixed_father' + GENERATED_IMAGE_NUM + '.png'), 
                             load_Gs(fpath), w=1024, h=1024, src_seeds=[5000], dst_seeds=[0,0,0],
                             style_ranges=[range(0,4)]+[range(4,8)]+[range(8,18)])
    draw_style_mixing_figure(os.path.join('mother_imgs', 'mixed_mother' + GENERATED_IMAGE_NUM + '.png'), 
                             load_Gs(fpath), w=1024, h=1024, src_seeds=[10000], dst_seeds=[0,0,0],
                             style_ranges=[range(0,4)]+[range(4,8)]+[range(8,18)])
